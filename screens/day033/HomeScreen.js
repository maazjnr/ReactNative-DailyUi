...
const HomeScreen = ({ navigation }) => {
  ...
  const COLORS = [
    { image: require("./iphone-black.png") },
    { image: require("./iphone-blue.png") },
    { image: require("./iphone-purple.png") },
    { image: require("./iphone-red.png") },
  ];
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#bdc3c7" }}>
      ...
      <View style={{ marginHorizontal: 12, marginVertical: 8 }}>
        <Text
          style={{ fontFamily: "Poppins-Medium", color: "#000", fontSize: 35 }}
        >
          iPhone 14
        </Text>
        <Image
          source={COLORS[selectedColor].image}
          style={{
            width: 200,
            height: 265,
            resizeMode: "center",
      ...
      >
        <Text
          style={{ fontFamily: "Poppins-Medium", color: "#000", fontSize: 20 }}
        >
          Storage
        </Text>
        ...
        >
          <TouchableOpacity
            style={{
              ...
              borderRadius: 20,
              borderWidth: selectedStorage === 0 ? 3 : 0,
              borderColor: "#0071e3",
            }}
          ...
          <TouchableOpacity
            style={{
              ...
              paddingHorizontal: 20,
              borderRadius: 20,
              borderWidth: selectedStorage === 1 ? 3 : 0,
              borderColor: "#0071e3",
            }}
          ...
          <TouchableOpacity
            style={{
              ...
              paddingHorizontal: 20,
              borderRadius: 20,
              borderWidth: selectedStorage === 2 ? 3 : 0,
              borderColor: "#0071e3",
            }}
        ...
        >
          ...
          <TouchableOpacity
            style={{
              backgroundColor: "#fc1b39",
              justifyContent: "center",
              alignItems: "center",
              borderRadius: 20,
              width: 40,
              height: 40,
              borderWidth: selectedColor === 3 ? 3 : 0,
              borderColor: "#0071e3",
            }}
        ...
        <Text
          style={{ fontFamily: "Poppins-Regular", color: "#000", fontSize: 20 }}
        >
          {selectedStorage === 0
            ? "$799"
            : selectedStorage === 1
