      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <Animated.View entering={FadeInDown.delay(300).duration(300)}>
          ...
          >
            ...
            />
            <Image
              source={require("./topgun.jpg")}
              style={{ width: 120, height: 250, resizeMode: "cover" }}
            />
            <Image
            ...
            >
              ...
              >
                <View>
                  ...
                  >{`Check out selection of the greatest movies of 2022`}</Text>
                </View>
            ...
            >
              ...
              >
                <View>
                  ...
                  >{`Listen to the hits from last year!`}</Text>
                </View>
                <Entypo name="chevron-right" size={40} color="#FFF" />
              </View>
            </View>
