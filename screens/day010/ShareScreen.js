    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#FFF' }}>
            ...
            <View style={{ padding: 12 }}>
                <Text style={{ fontSize: 20, fontFamily: 'Poppins-Medium', color: '#000' }}>Maazjnr #999</Text>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    <Image source={require('./imgs/MaazDp.jpg')} style={{ width: 30, height: 30, borderRadius: 25 }} />
                    <Text style={{ fontSize: 18, fontFamily: 'Poppins-Regular', color: '#000', marginLeft: 10 }}>Maaz's wonder land</Text>
                </View>
            </View>

            <View style={{ paddingHorizontal: 12 }}>
                <Image source={require('./imgs/mz.jpg')} style={{ width: 370, height: 370, borderRadius: 20, marginBottom: 20 }} />
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-evenly', marginBottom: 20 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <View>
                            ...
                            <Text style={{ fontSize: 18, fontFamily: 'Poppins-Regular', color: '#000', marginLeft: 10, marginTop: -8 }}>15h 31m</Text>
                        </View>
                    </View>
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <View>
                            ...
                            <Text style={{ fontSize: 18, fontFamily: 'Poppins-Regular', color: '#000', marginLeft: 10, marginTop: -8 }}>0.8 ETH</Text>
                        </View>
                    </View>
                </View>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                    ...
                    <TouchableOpacity style={{ paddingHorizontal: 8, paddingVertical: 6, borderWidth: 1, borderColor: '#932', borderRadius: 10, width: 180, justifyContent: 'center', alignItems: 'center', backgroundColor: "#932"}}>
                        <Text style={{ fontSize: 18, fontFamily: 'Poppins-Regular', color: '#fff', textAlign: 'center' }}>Place Bid</Text>
                    </TouchableOpacity>

                    <TouchableOpacity style={{ paddingHorizontal: 8, paddingVertical: 6, borderWidth: 1, borderColor: '#932', borderRadius: 10, width: 180, justifyContent: 'center', alignItems: 'center' }}
                        onPress={() => setIsModalVisible(true)}>
                        <Text style={{ fontSize: 18, fontFamily: 'Poppins-Regular', color: '#932', textAlign: 'center' }}>Share</Text>
                    </TouchableOpacity>
