...
const CheckoutScreen = () => {
    return (
        <View style={{ flex: 1 }}>
                ...
                <FadeIn delay={300}>
                    <View style={{ backgroundColor: '#FFF', borderRadius: 10, paddingVertical: 10, paddingHorizontal: 20 }}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                            <Text style={{ fontSize: 18, fontFamily: 'Poppins-Medium', color: '#c64' }}>Credit Card</Text>
            ...
            <FadeIn delay={900} >
                <TouchableOpacity
                    style={{ marginBottom: 30, width: 250, backgroundColor: '#c64', borderRadius: 20, justifyContent: 'center', alignItems: 'center', padding: 10, alignSelf: 'center', marginTop: 20 }}>
