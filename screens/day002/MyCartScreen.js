            ...
            <FadeIn delay={600}>
                    <View style={{ backgroundColor: '#ffffff', borderRadius: 10, padding: 10, flexDirection: 'row' }}>
                        ...
                        <View style={{ paddingHorizontal: 20 }}>
                            <Text style={{ fontSize: 18, fontFamily: 'Poppins-Regular', color: '#c64' }}>Smart Watch</Text>
                ...
                <FadeIn delay={300}>
                    <View style={{ backgroundColor: '#ffffff', borderRadius: 10, padding: 10, flexDirection: 'row', marginBottom: 20 }}>
                        ...
                        <View style={{ paddingHorizontal: 20 }}>
                            <Text style={{ fontSize: 18, fontFamily: 'Poppins-Regular', color: '#c64'}}>Sneakers</Text>
                ...
                <FadeIn delay={1200}>
                    <TouchableOpacity
                        style={{ width: 250, backgroundColor: '#c64', borderRadius: 20, justifyContent: 'center', alignItems: 'center', padding: 10, alignSelf: 'center', marginTop: 20 }}
