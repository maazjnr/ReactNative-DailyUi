  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#FFF"}}>
     <Animated.View entering={FadeInDown.delay(300).duration(300)}>
      ...
      <Animated.View
        style={{ flex: 1, backgroundColor: "#011f2b", paddingVertical: 20 }}
      ...
      >
        ...
        >{`Feel free to use the resources but please threat our brand well. Donwload the grand guideline if you feel insecure.`}</Text>
        <TouchableOpacity
          style={{
            padding: 15,
            backgroundColor: "#FFF",
