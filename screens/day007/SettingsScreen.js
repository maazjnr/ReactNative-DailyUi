            ...
            <View style={{ padding: 12 }}>
                ...
                <FadeIn delay={300}>
                    <View style={{ flexDirection: 'row', marginTop: 40, paddingBottom: 30, borderBottomColor: '#6e7e87', borderBottomWidth: 0.5 }}>
                        <Image source={require('./imgs/MaazDp.jpg')} style={{ width: 100, height: 100, borderRadius: 50 }} />
                        ...
                        <View style={{ marginLeft: 20, justifyContent: 'center' }}>
                            <Text style={{ fontSize: 18, fontFamily: 'Poppins-Medium', color: '#FFF' }}>Maaz Junior</Text>
                            <Text style={{ fontSize: 16, fontFamily: 'Poppins-Medium', color: '#6e7e87' }}>maazjunior5@gmail.com</Text>
                        </View>
                    </View>
                </FadeIn>
                <FadeIn delay={600}>
