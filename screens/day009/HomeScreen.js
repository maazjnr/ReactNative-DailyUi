        ...
        <View style={{ flex: 1, backgroundColor: '#1a1b1f' }}>
            ...
            <View style={{ padding: 12 }}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                    <View>
                        <Text style={{ fontSize: 20, fontFamily: 'Poppins-Medium', color: '#FFF' }}>Hey Maaz 😍</Text>
                        <Text style={{ fontSize: 14, fontFamily: 'Poppins-Regular', color: '#848588' }}>Explore some amazing music today</Text>
                    </View>
