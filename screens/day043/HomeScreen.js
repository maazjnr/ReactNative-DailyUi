        ...
        <Animated.View entering={FadeInDown.delay(2000).duration(400)}>
          ...
          >
            <View
              style={{
                padding: 18,
                backgroundColor: "#e6cef0",
                borderTopLeftRadius: 10,
                borderBottomLeftRadius: 10,
              }}
            >
              <Image
                source={require("./fries.png")}
                style={{ width: 35, height: 35 }}
              />
            </View>
            <View
        ...
        <Animated.View entering={FadeInDown.delay(2400).duration(400)}>
          ...
          >
            <View
              style={{
                padding: 18,
                backgroundColor: "#e0c4ab",
                borderTopLeftRadius: 10,
                borderBottomLeftRadius: 10,
              }}
            >
              <Image
                source={require("./nuggets.png")}
                style={{ width: 35, height: 35 }}
              />
            </View>
            <View
