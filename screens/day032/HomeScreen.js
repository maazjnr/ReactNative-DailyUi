...
const HomeScreen = ({ navigation }) => {
  return (
    <View style={{ backgroundColor: "#f6f6f6", padding: 12, flex: 1 }}>
      <Text style={{ fontFamily: "Poppins-Bold", color: "#000", fontSize: 20 }}>
        Projects
      </Text>
      ...
      >
        ...
        <TextInput
          placeholder="Search"
          placeholderTextColor="#c2c0c1"
          style={{ fontFamily: "Poppins-Medium", flex: 1, marginLeft: 8 }}
        />
      </View>
