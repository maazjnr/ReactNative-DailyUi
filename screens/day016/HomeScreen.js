        ...
        <View style={{ flex: 1, backgroundColor: '#FFF' }}>
            ...
            <FadeIn delay={100}>
                ...
                <View style={{ padding: 12 }}>
                    <Text style={{ fontSize: 20, fontFamily: 'Poppins-Medium', color: '#000' }}>#99977</Text>
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        <Image source={require('./imgs/MaazDp.jpg')} style={{ width: 50, height: 50, borderRadius: 25 }} />
                        <Text style={{ fontSize: 18, fontFamily: 'Poppins-Regular', color: '#000', marginLeft: 10 }}>Fantasy! Fantasy!! Fantasy!!!</Text>
                    </View>
                </View>
            </FadeIn>
