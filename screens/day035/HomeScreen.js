...
const HomeScreen = ({ navigation }) => {
  return (
    <View style={{backgroundColor: "#fff", padding: 12, flex: 1}}>
      ...
      >
        <Text
          style={{ fontFamily: "Poppins-Bold", color: "#263238", fontSize: 20 }}
        >
          Popular
        </Text>
        <Text
          style={{ fontFamily: "Poppins-Bold", color: "#ed6527", fontSize: 14 }}
        >
          Show all
        </Text>
      </View>
