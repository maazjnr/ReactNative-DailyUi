...
const HomeScreen = ({ navigation }) => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#FFF" }}>
      ...
      >
        <Text
          style={{ fontFamily: "Poppins-Medium", fontSize: 18, color: "#000" }}
        >
          14 jobs found
        </Text>
        <View
          style={{ padding: 12, backgroundColor: "#fcfbfe", borderRadius: 10 }}
        >
