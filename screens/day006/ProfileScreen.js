        ...
        <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
            ...
            <ScrollView  contentContainerStyle={{paddingBottom: 20}}>
                <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <Text style={{ fontSize: 25, fontFamily: 'Poppins-Medium', color: '#1f2c3c' }}>Summer Chi</Text>
                    <Text style={{ fontSize: 15, fontFamily: 'Poppins-Regular', color: '#1f2c3c' }}>Programmer || iOS Developer</Text>
