...
const HomeScreen = ({ navigation }) => {
  ...
  return (
   ...
   <View
      ...
      >
        <Text
          style={{ fontFamily: "Poppins-Medium", color: "#FFF", fontSize: 20 }}
        >{`MZ`}</Text>
      </View>
      <Text
        style={{
        ...
        <Animated.View entering={FadeInDown.delay(2000).duration(500)}>
          ...
          >
            ...
            <Image
              ...
              style={{ width: 168, height: 60, alignSelf: "center" }}
            />
            <View
              style={{
