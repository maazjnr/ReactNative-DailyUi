...
const SignUpScreen = () => {
    return (
        <View style={{ flex: 1, padding: 20, backgroundColor: '#e1e4ee', alignItems: 'center' }}>
            ...
            <FadeIn delay={300}>
                <Text style={{ fontFamily: 'Poppins-Medium', fontSize: 30, color: '#fd8b64', textAlign: 'center', marginTop: 40 }}>{`Hello!`}</Text>
            ...
            <FadeIn delay={500}>
                ...
                <TouchableOpacity style={{ backgroundColor: '#fd8b64', width: 350, borderRadius: 10, marginTop: 50, paddingVertical: 15 }}>
