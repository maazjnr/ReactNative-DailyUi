    ...
    <View style={{ padding: 12 }}>
      ...
      <View style={{ marginTop: 20 }}>
        ...
        <ScrollView horizontal style={{ height: 100 }}>
          ...
          <View style={{ alignItems: "center", marginLeft: 10 }}>
            <Image
              source={require("./imgs/theweek.jpg")}
              style={{ width: 70, height: 70, borderRadius: 40 }}
            />
            <Text
              style={{
