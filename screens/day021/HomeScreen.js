...
const HomeScreen = ({ navigation }) => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#f6f8fa" }}>
      ...
      >
        Setup your home monitoring activities
      </Text>
        ...
        >
          ...
          >
            <FontAwesome5
              name="lightbulb"
              size={30}
              color={isEnabled2 ? "#f79f1a" : "#d1d3d6"}
            />
            <Text
              style={{
                fontSize: 16,
          ...
          >
            ...
            <View style={{ alignItems: "center" }}>
              <TouchableOpacity
                ...
                onPress={() => setTemp2((prevState) => prevState + 1)}
              >
                <FontAwesome5
                  name="sort-up"
                  size={30}
